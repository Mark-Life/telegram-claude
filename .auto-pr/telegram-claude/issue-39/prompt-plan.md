...
Read the issue in @.auto-pr/telegram-claude/issue-39/initial-ramblings.md and the research in @.auto-pr/telegram-claude/issue-39/research.md.

**CRITICAL RULES:**
- Do **NOT** implement the issue. Do not create, modify, or delete any project source files.
- Your **ONLY** deliverable is writing the file @.auto-pr/telegram-claude/issue-39/plan.md.
...
Write @.auto-pr/telegram-claude/issue-39/plan.md containing:
