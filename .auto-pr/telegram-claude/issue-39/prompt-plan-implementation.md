...
Read the issue in @.auto-pr/telegram-claude/issue-39/initial-ramblings.md, the research in @.auto-pr/telegram-claude/issue-39/research.md, and the plan in @.auto-pr/telegram-claude/issue-39/plan.md.

**CRITICAL RULES:**
- Do **NOT** implement the issue. Do not create, modify, or delete any project source files.
- Your **ONLY** deliverable is writing the file @.auto-pr/telegram-claude/issue-39/plan-implementation.md.

The code for this project lives primarily at `./`.

Write @.auto-pr/telegram-claude/issue-39/plan-implementation.md with:
