...
- [x] **Task 1: Add git helper functions to bot.ts**
  - Files: `src/bot.ts`
...
- [x] **Task 2: Add branch info to response footer in telegram.ts**
...
- [x] **Task 3: Pass branch name from handlePrompt to streamToTelegram in bot.ts**
  - Files: `src/bot.ts`
...
- [x] **Task 4: Add branch info to pinned message on project selection**
  - Files: `src/bot.ts`
...
- [x] **Task 5: Add branch info to /status command**
  - Files: `src/bot.ts`
...
- [x] **Task 8: Register new commands in index.ts and update help text in bot.ts**
